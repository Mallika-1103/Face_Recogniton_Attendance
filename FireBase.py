...
cred = credentials.Certificate(r"D:\AvaSoft_Project\ServiceAccountKey.json")
firebase_admin.initialize_app(cred,{
    'databaseURL':"https://faceattendancesystem-66517-default-rtdb.firebaseio.com/", #DataBase Name
    'storageBucket':"faceattendancesystem-66517.appspot.com"                         #Storage path
})
